...
// Menu is now backend-owned. The frontend fetches GET /api/menu instead of
// bundling this list. `modelUrl` is where a hero item's GLB path goes once
// you've sourced the 3D models (e.g. '/models/biryani.glb').
